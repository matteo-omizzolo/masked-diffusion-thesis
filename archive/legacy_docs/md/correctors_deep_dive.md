> **DEPRECATED (April 2026):** Superseded by the refocused thesis direction.
> See `docs/thesis_direction.md`. Retained for historical reference on corrector
> mechanics. Archived copy: `archive/legacy/correctors_deep_dive.md`.
