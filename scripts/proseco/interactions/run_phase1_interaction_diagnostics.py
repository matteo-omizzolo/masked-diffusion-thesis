...
-----
    ...
    python scripts/proseco/interactions/run_phase1_interaction_diagnostics.py --surrogate \\
        --K 4 --seed_start 42 \\
        --protocol_a_dir results/phase1_proseco_owt_full/protocol_a \\
        --out_dir /tmp/phase1_test_run

    # HPC real run (one call per GPU shard)
    python scripts/proseco/interactions/run_phase1_interaction_diagnostics.py \\
